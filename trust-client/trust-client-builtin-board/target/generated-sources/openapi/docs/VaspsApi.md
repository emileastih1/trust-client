...
|------------- | ------------- | -------------|
| [**v1VaspsGet_0**](VaspsApi.md#v1VaspsGet_0) | **GET** /v1/vasps | Retrieve the information of all VASPs |
| [**v1VaspsVaspIdGet_0**](VaspsApi.md#v1VaspsVaspIdGet_0) | **GET** /v1/vasps/{vaspId} | Retrieve the information of a specific VASP |



## v1VaspsGet_0

> GetVASPResponse1 v1VaspsGet_0()
...
import io.trust.client.api.VaspsApi;
...
public class Example {
    public static void main(String[] args) {
        ...
        VaspsApi apiInstance = new VaspsApi(defaultClient);
        try {
            GetVASPResponse1 result = apiInstance.v1VaspsGet_0();
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling VaspsApi#v1VaspsGet_0");
...
> GetVASPResponse v1VaspsVaspIdGet_0(vaspId)
...
public class Example {
    public static void main(String[] args) {
        ...
        try {
            GetVASPResponse result = apiInstance.v1VaspsVaspIdGet_0(vaspId);
            System.out.println(result);
        } catch (ApiException e) {
            System.err.println("Exception when calling VaspsApi#v1VaspsVaspIdGet_0");
            System.err.println("Status code: " + e.getCode());
            System.err.println("Reason: " + e.getResponseBody());
            System.err.println("Response headers: " + e.getResponseHeaders());
            e.printStackTrace();
